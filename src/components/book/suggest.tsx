    ...
    if (title && author && reason) {
      ...
      if (res.success) {
        toast({
          status: "success",
          title: "Success!",
          description: "Thank you for sending me a book recommendation ❤️",
          isClosable: true,
        });
        setTitle("");
        setAuthor("");
        ...
        toast({
          status: "error",
          title: "Oops!",
          description: "Oh darn... Something went wrong, please try again 😵",
          isClosable: true,
        });
      }
      setLoading(false);
      ...
      toast({
        status: "warning",
        title: "Oh no",
        description: "Sorry but all fields are required 🥲",
        isClosable: true,
      });
    }
  };
        ...
        >
          ...
          <GridItem colSpan={{ base: 1, md: 2 }}>
            <Textarea
              ...
              placeholder="Why do you like this book?"
              required
              value={reason}
              variant="filled"
            />
