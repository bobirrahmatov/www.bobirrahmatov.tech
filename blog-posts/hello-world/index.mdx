...
As you can tell by the fact you are now reading this, I now have a blog 🎉. This means that I finally have a place to write lengthy articles that can go more in-depth on topics I am really curious about, ranging from the usual softwares to machine learning.

My new [projects page](/projects) has been redesigned to use server-side rendering for a very unique purpose.
The page will show a number of projects that are publicly available on my GitHub repo. But, the way they are selected is very unique. That’s the final result of the website that you are currently visiting. I hope you enjoyed reading this post.
